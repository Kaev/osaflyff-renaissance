...
namespace FlyffWorld
{
    public partial class Mover : PacketCommands
    {
        ...
        public List<Buff> antibuffs = new List<Buff>();
        ...
        public Point c_lastposition = new Point(0, 0, 0, 0);
        ...
        public bool bIsBlocked = false;
        private double m_dwMoverSpeed = 0.1;


        public List<DelayedActions.Delaycontent> list_delayedprocess = new List<DelayedActions.Delaycontent>();
        ...
        public void followMover(int TargetmoverID, int range)
        {

...
namespace FlyffWorld
{
    public partial class WorldThreads
    {
        public void MonsterVisibilityThreadProcess()
        {
            ...
            {
                Log.Write(Log.MessageType.fatal, "Monster visibility thread terminated due to an exception.");
                Log.Write(Log.MessageType.fatal, "Error message: " + e.Message);
                Log.Write(Log.MessageType.fatal, "Stack trace: " + e.StackTrace);
                Log.Write(Log.MessageType.notice, "Restarting monster visibility thread.");
        ...
        public void VisibilityThreadProcess()
        {
            ...
            {
                Log.Write(Log.MessageType.fatal, "Visibility thread terminated due to an exception.");
                Log.Write(Log.MessageType.fatal, "Error message: " + e.Message);
                Log.Write(Log.MessageType.fatal, "Stack trace: " + e.StackTrace);
                Log.Write(Log.MessageType.notice, "Restarting visibility thread.");
